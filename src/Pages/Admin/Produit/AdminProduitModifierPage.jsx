...
const AdminProduitModifierPage = () => {
	...
	const handleUpload = async (e) => {
		...
		if (!formData.titre) {
			setErreur("❌ Le titre du produit est requis pour l'upload.");
			return;
		}
	...
	return (
		<>
			<Helmet>
				<title>Tech City - Modifier un produit</title>
			</Helmet>
			<Header />
			<main className="main-content">
				...
				<div className="content-section">
					<h1 style={{ textAlign: "center", marginBottom: "20px" }}>Modifier le produit</h1>
					<div style={{ display: "flex", justifyContent: "flex-end", marginBottom: "10px" }}>
						<button className="secondaryButton" style={{ padding: "8px 16px" }} onClick={() => navigate(`/admin/produits/${id}`)}>
							← Retour
						</button>
					</div>
...
export default AdminProduitModifierPage;
